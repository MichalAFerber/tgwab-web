...
export const portfolio: PortfolioEntry[] = [
  ...
  },
  {
    ...
    tagline: "Browsable tree view for public GitHub repos — scope TBD",
    description: "Browsable tree view for public GitHub repos — scope TBD",
    url: "https://github.com/MichalAFerber/resources",
    status: "planning",
    tier: 1,
    category: "script",
  ...
  },
  {
    ...
    description: "Privacy-first Proton affiliate site — get Google out of your life",
    url: "https://degoog.us",
    status: "planning",
    tier: 1,
    category: "website",
