...
![ModMan_About.png](/wiki-assets/ModMan_About.png)
...
![ModMan_WindowsProtected1.png](/wiki-assets/ModMan_WindowsProtected1.png)

Then click the `Run anyway` button. You should only encounter this the first time you run the program.

![ModMan_WindowsProtected2.png](/wiki-assets/ModMan_WindowsProtected2.png)
## Setting It Up
...
![ModMan_FileProperties.png](/wiki-assets/ModMan_FileProperties.png)
...
![ModMan_Screenshot.png](/wiki-assets/ModMan_Screenshot.png)
...
![ModMan_ShowAdvancedMenuOption.png](/wiki-assets/ModMan_ShowAdvancedMenuOption.png)

![ModMan_SelectedModFolder.png](/wiki-assets/ModMan_SelectedModFolder.png)
